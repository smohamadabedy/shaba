    ...
    const shaba = {
        ...
        getBankFromCard(prefix) {
            const map = {
                ...
                '639370': ["mehreqtesad", "639370", "بانک مهراقتصاد"],
        ...
        getBankFromShaba(code) {
            const map = {
                ...
                '060': ["gharzolhasaneh", "بانک قرض الحسنه مهر", "060"],
                '061': ["shahr", "بانک شهر", "061"],
                '062': ["tat", "بانک تات", "062"],
            ...
            return map[code] || ["no-img", "بانک مرکزی", "000"];
        }
    };
